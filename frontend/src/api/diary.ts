...
export const memoryApi = {
  ...
  approveCandidate: (id: number, data?: { editedValue?: string }) => api.post(`/memory/candidates/${id}/approve`, data),
  rejectCandidate: (id: number, data?: { reason?: string }) => api.post(`/memory/candidates/${id}/reject`, data),
