...
<style scoped>
.life-page { min-height: 100vh; padding: 42rpx 36rpx 140rpx; box-sizing: border-box; background: var(--theme-bg); }.page-header { display: flex; align-items: flex-end; justify-content: space-between; gap: 20rpx; margin: 28rpx 0 54rpx; }.eyebrow, .sheet-kicker { display: block; margin-bottom: 12rpx; color: var(--theme-primary); font-size: 20rpx; font-weight: 700; letter-spacing: 4rpx; }.title-with-info { display: flex; align-items: center; gap: 12rpx; }.page-title { display: block; color: var(--theme-text-primary); font-family: Georgia, serif; font-size: 58rpx; font-weight: 700; }.info-button { display: inline-flex; width: 34rpx; height: 34rpx; align-items: center; justify-content: center; margin-top: 8rpx; border: 1rpx solid var(--theme-primary); border-radius: 50%; color: var(--theme-primary); font-size: 22rpx; font-weight: 700; }.page-desc { display: block; max-width: 560rpx; margin-top: 18rpx; color: var(--theme-text-secondary); font-size: 25rpx; line-height: 1.7; }.add-button { flex-shrink: 0; padding: 16rpx 20rpx; border-radius: 6rpx; background: var(--theme-primary); color: #fff; font-size: 23rpx; }.event-list { border-top: 1rpx solid var(--theme-border); }.event-item { display: flex; gap: 24rpx; padding: 30rpx 0; border-bottom: 1rpx solid var(--theme-border); }.event-date { width: 170rpx; flex-shrink: 0; color: var(--theme-text-placeholder); font-size: 21rpx; line-height: 1.6; }.date-main { display: block; color: var(--theme-text-primary); font-family: Georgia, serif; font-size: 27rpx; }.event-main { min-width: 0; flex: 1; }.event-title, .event-desc, .event-meta { display: block; }.event-title { color: var(--theme-text-primary); font-family: Georgia, serif; font-size: 32rpx; font-weight: 700; }.event-desc { margin-top: 9rpx; color: var(--theme-text-secondary); font-size: 24rpx; line-height: 1.6; }.event-meta { margin-top: 12rpx; color: var(--theme-text-placeholder); font-size: 21rpx; }.event-actions { display: flex; flex-wrap: wrap; gap: 24rpx; margin-top: 20rpx; font-size: 23rpx; }.event-chat { color: var(--theme-primary); font-weight: 650; }.event-action { color: var(--theme-text-secondary); }.state { padding: 80rpx 20rpx; color: var(--theme-text-secondary); font-size: 26rpx; line-height: 1.7; text-align: center; }.undo-toast { position: fixed; right: 30rpx; bottom: calc(30rpx + env(safe-area-inset-bottom)); z-index: 30; display: flex; padding: 22rpx 28rpx; border: 1rpx solid var(--theme-border); border-radius: 8rpx; background: var(--theme-surface); color: var(--theme-text-primary); box-shadow: 0 10rpx 30rpx rgba(0,0,0,.16); font-size: 24rpx; }.undo-action { color: var(--theme-primary); font-weight: 700; }.modal-overlay { position: fixed; inset: 0; z-index: 50; display: flex; align-items: flex-end; background: rgba(21,25,22,.4); }.editor-sheet { width: 100%; max-height: 90vh; padding: 24rpx 32rpx calc(24rpx + env(safe-area-inset-bottom)); box-sizing: border-box; border-radius: 14rpx 14rpx 0 0; background: var(--theme-surface); }.info-sheet { width: 100%; padding: 28rpx 32rpx calc(28rpx + env(safe-area-inset-bottom)); box-sizing: border-box; border-radius: 14rpx 14rpx 0 0; background: var(--theme-surface); }.sheet-header { display: flex; align-items: flex-start; justify-content: space-between; }.sheet-title { display: block; color: var(--theme-text-primary); font-size: 34rpx; font-weight: 650; }.sheet-close { color: var(--theme-text-secondary); font-size: 44rpx; line-height: 1; }.info-content { margin-top: 24rpx; color: var(--theme-text-secondary); font-size: 25rpx; line-height: 1.75; }.info-content text { display: block; margin-bottom: 14rpx; }.info-content text:last-child { margin-bottom: 0; }.info-actions { display: inline-block; margin-top: 24rpx; padding: 16rpx 28rpx; border-radius: 5rpx; background: var(--theme-primary); color: var(--theme-surface); font-size: 25rpx; }
