...
.music-cover, .music-cover-fallback { width: 96rpx; height: 96rpx; flex: 0 0 96rpx; border-radius: 5rpx; background: rgba(var(--theme-primary-rgb), .12); }
...
.music-tag { padding: 3rpx 9rpx; border-radius: 99rpx; background: rgba(var(--theme-primary-rgb), .09); color: var(--theme-primary); font-size: 18rpx; line-height: 1.45; }
...
.music-play { display: flex; width: 54rpx; height: 54rpx; flex: 0 0 54rpx; align-items: center; justify-content: center; align-self: center; border-radius: 50%; background: var(--theme-primary); color: #fff; font-size: 20rpx; }
