...
<style scoped>
.announcement-mask { position: fixed; inset: 0; z-index: 10030; display: flex; align-items: center; justify-content: center; padding: 42rpx; box-sizing: border-box; background: var(--theme-overlay); }
.announcement-card { position: relative; width: 100%; max-width: 620rpx; max-height: 78vh; padding: 42rpx; box-sizing: border-box; background: var(--theme-surface); border-top: 8rpx solid var(--theme-primary); border-radius: var(--theme-radius-lg); box-shadow: var(--theme-shadow-dialog); }
...
.announcement-confirm { padding: 13rpx 24rpx; border-radius: var(--theme-radius-sm); background: var(--theme-primary); color: var(--theme-text-on-primary); font-size: 25rpx; }
</style>
