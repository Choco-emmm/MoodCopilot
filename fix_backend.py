...
with open('D:/Code/MoodCopilot/backend/moodcopilot/src/main/java/com/moodcopilot/auth/AuthService.java', 'r', encoding='utf-8') as f:
    content = f.read()
...
content = content.replace('账号ID需为 4-20 位字母、数字、下划线或横线', '账号ID需为 2-20 位中英文字母、数字、下划线或横线')
