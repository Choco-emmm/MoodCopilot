...
*   **双模型智能路由与深度思考**：底层全面接入 DeepSeek 生态。日常闲聊时极速响应，涉及复杂情绪分析和深度日记回顾时，自动无缝开启**深度思考模式（Reasoner）**。AI 在给出最终回复前会先进行一段心理学角度的沉思，为你提供更有深度、更共情的解答。
...
| **AI 模型栈** | **DeepSeek V3 / R1** (纯手写 WebClient 实现流式思考过程解析) + **DashScope VLM** (qwen-vl 等) |
