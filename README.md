...
**1. 匿名鼓励**
- 将"共鸣"从一键点击扩展为「选一句 AI 生成的鼓励话」匿名发送
- AI 生成 3 个候选短句（基于日记内容），用户选一个发送
- 低成本高回报，直接提升互动温度和频次

**2. 每日跟进**
- 每天打开 App 时轻量提示：「你今天感觉怎么样？和昨天比呢？」
- 显示连续记录天数，形成轻量打卡激励
- 不打扰、有价值的留存机制
...
**4. 限时匿名贴**（替代漂流瓶）
- 发送后 24h 自动消失，降低 spam 动力
- 轻量、有仪式感

**5. 今日同频卡片**
- 广场首页顶部推荐一篇和自己情绪相似的日记
- 整合而非独立页面
