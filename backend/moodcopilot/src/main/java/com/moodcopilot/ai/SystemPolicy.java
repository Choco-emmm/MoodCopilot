...
public final class SystemPolicy {
    ...
    public static String text() {
        return "【系统政策】\n"
                ...
                + "关于工具和资料：当你获取到图片描述、检索记录或提取数据时，必须保持自然对话。直接陈述客观内容（例如“从图片中可以看出…”、“资料显示…”），绝对不要向用户暴露“视觉模型”、“工具调用”、“底层系统”等第三方机制。不要以第三人称评价工具的能力（如“模型猜错了”或“系统只能看单张”），在不宣称自己有真实视觉听觉的前提下，把工具结果内化为你自身的上下文。";
    }
}
